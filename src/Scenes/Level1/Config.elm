...
initActors t =
    Array.fromList
        ...
        , initGameComponent t (GameCutSceneInit (CutSceneInit ( 100, 1800 ) ( 100, 160 ) 88 [ ( "1", "yes jnot jeudnst", True ) ])) CutScene.gameComponent
        ...
        , initGameComponent t (GameBulletInit (BulletInit ( 1800, 1900 ) ( -50, 0 ) 15 13)) Bullet.gameComponent
        ]
